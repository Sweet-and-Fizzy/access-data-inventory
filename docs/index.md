...
| [Affinity Groups](field-dictionary#affinity_groups) | Community groups organized by interest or domain | Public | [MCP](https://access-mcp.netlify.app/servers/affinity-groups) · [API](https://support.access-ci.org/api/1.1/affinity_groups) |
| [Announcements](field-dictionary#announcements) | Resource provider and community announcements | Public | [MCP](https://access-mcp.netlify.app/servers/announcements) · [API](https://support.access-ci.org/api/2.2/announcements) |
| [Event Registrations](field-dictionary#event_registrations) | Registration and attendance data for events | Restricted |  |
| [Events and Training](field-dictionary#events) | Workshops, webinars, training sessions, and office hours | Public | [MCP](https://access-mcp.netlify.app/servers/events) · [API](https://support.access-ci.org/api/2.2/events) |
